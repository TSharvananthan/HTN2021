    ...
    <div>
      ...
      <section className="text-center section-c">
        <div class=" container ">
          ...
          <p>
            Every year, hundreds of thousands of new businesses open up, but how
            do businesses know how customers are feeling? It takes time to find
            the right views and often there is ambiguity. This brought us an
            idea to help business and as welll as customers to have an app to
            find lots of views that are simplified with no more wondering how a
            customer feel, and allows others to find the service they need for
      ...
      <section className="text-center section-d">
        ...
        <div class=" container content">
          ...
          <p>
            ...
            mock interviews and in-person workshops are no longer available. So,
            we created InterviewBuddy at StormHacks 2021. An online tool that
            provides feedback to the answers you give during the one-way
            interview.
          </p>
        </div>
      </section>
